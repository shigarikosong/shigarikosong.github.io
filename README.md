...
開発・保守を始める場合は、最初に[Project Guide](AGENTS.md)を確認してください。作業フロー、主要ファイル、詳細仕様への案内をまとめています。
...
このリポジトリのソースコードと開発者向け文書は、特に記載がない限り[MIT License](LICENSE)で利用できます。

MIT Licenseは、`data/`配下の動画データ、サイトに掲載する文章、画像・アイコン・ロゴ、リンク先の動画や第三者のコンテンツには適用されません。YouTube、TikTok、Xを含む名称・ロゴ・コンテンツの権利は、それぞれの権利者に帰属します。
